...
public enum PacketType {
    ...
    PACKET_IN_SETTING_CHANGE,
    PACKET_OUT_SETTING_CHANGE,
    PACKET_OUT_PLAYER_ELIMINATED,
    PACKET_OUT_LIVES_CHANGE,
    PACKET_OUT_PLAYER_JOIN,
    PACKET_OUT_PLAYER_QUIT,
    PACKET_OUT_GAME_END,
    PACKET_OUT_DEFINITION,
    PACKET_OUT_EXPERIENCE_CHANGE;
}
