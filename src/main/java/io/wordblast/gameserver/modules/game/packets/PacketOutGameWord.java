...
/**
 * Packet representing a word as the player attempts to come up with a valid word This is NOT a word
 * submission - this is so that other players in the game can watch how the player comes up with a
 * word while in-game.
 */
